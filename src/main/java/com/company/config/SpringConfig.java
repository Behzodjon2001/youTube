...
public class SpringConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/video/adnOwn/*").hasAnyRole("ADMIN", "OWNER")
                .antMatchers("/video/publisher/*").hasRole( "PUBLISHER")
                .antMatchers("/video/mod/*").hasRole( "MODERATOR")
                .antMatchers("/videoTag/userOwn/*").hasAnyRole("USER", "OWNER")
                ...
                .antMatchers("/channel/ownUser/**").hasAnyRole("USER", "OWNER")
                .antMatchers("/channel/AOU/**").hasAnyRole("USER", "OWNER", "ADMIN")
                .antMatchers("/channel/admin").hasRole("ADMIN")
                .antMatchers("/playlist/ownUser/*").hasAnyRole("USER", "OWNER")
                .antMatchers("/playlist/AOU/*").hasAnyRole("USER", "OWNER", "ADMIN")
                .antMatchers("/playlist/OU/*").hasAnyRole("USER", "OWNER")
                .antMatchers("/playlistVideo/userOwn/*").hasAnyRole("USER", "OWNER")
                .antMatchers("/playlist/admin").hasRole("ADMIN")
                .antMatchers("/playlist/public/**").permitAll()
                .antMatchers("/video/user").hasRole("ADMIN")
                .antMatchers("/video/ownUser/**").hasAnyRole("USER", "OWNER")
